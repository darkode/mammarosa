...
console.log('doSqlQuery!!!!! ' + sql);


console.log('new doSqlQuery!!!!! ' + sql);
...
// myitemFieldvalues.push(raw_data);
console.log(myitemFieldvalues);
                 //  new_sql = new_sql + Where;
itemFieldvalues[0] = escape(itemFieldvalues[0]);
            ...
            //     sql = sql + ', "blob"="'+ raw_data +'" WHERE "image_md5"=`' + itemFieldvalues[3] +'`;';
                 ...
                 setTimeout(function() {
                     doSqlQuery(sql,myitemFieldvalues);
                 }, 3000);
...
fieldnameSet = fieldnameSet + '`'+fieldName[n] +'`=`' + fieldValue[n]+'`, ';
              ...
              writeSqlRecord(data)
                    .then(function(ress) {
                        ...
                        console.log( ress );
                                ...
                                var fieldValuesArray = ress[1][1][2][0].fieldValues;

                                var myFileName = fieldValuesArray[3];
                                var myURL = fieldValuesArray[1];
                              ...
                              // console.log(myURL,myFileName, tableName  ,  sqlStatementUpdate , fieldValuesArray);
                                   ...
                                   downloadURL(myURL,myFileName, tableName  ,  sqlStatementUpdate , fieldValuesArray);
                                   console.log('ja ja');
